...
- 生成时间(UTC): 2026-08-27T12:53:18.251267+00:00
...
- 参数: `{"embedding_dimensions": 1024, "skip_check": true, "skip_setup": true, "only": "dedup", "corpus_limit": 1000, "query_limit": 100, "sample": 100, "verifier": "none", "seed": 42}`

### 实体去重

| 配置 | Precision | Recall | F1 |
|---|---|---|---|
| Pairwise | 0.6667 | 0.5 | 0.5556 |
